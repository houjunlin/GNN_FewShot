...
def train_batch(model, data): #计算loss
...
def train():
    ...
    # #create_G
    # G = build_batch_graph(args.batch_size, args.train_N_way * args.train_N_shots+1)
    # Gtest = build_batch_graph(args.batch_size_test, args.train_N_way * args.train_N_shots+1)
