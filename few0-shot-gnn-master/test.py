...
def test_one_shot(args, model, test_samples=5000, partition='test'):
    ...
    for i in range(iterations):
        ...
        [x, labels_x_cpu, _, _, xi_s, labels_yi_cpu, oracles_yi, hidden_labels,labels_mask] = data
        ...
        x = Variable(x)
        labels_mask=Variable(labels_mask)
        ...
        output, out_logits = metric_nn(inputs=[z, zi_s, labels_yi, oracles_yi, hidden_labels,labels_mask])
        output = out_logits
