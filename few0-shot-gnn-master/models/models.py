...
class MetricNN(nn.Module):
    ...
    def gnn_iclr_forward(self, z, zi_s, labels_yi,labels_mask):
        # Creating WW matrix
        ...
        logits = self.gnn_obj(nodes,labels_mask).squeeze(-1)
    ...
    def forward(self, inputs):
        ...
        [z, zi_s, labels_yi, oracles_yi, hidden_labels,labels_mask] = inputs
        ...
        if 'gnn_iclr_active' in self.metric_network:
           return self.gnn_iclr_active_forward(z, zi_s, labels_yi, oracles_yi, hidden_labels)
            ...
            return self.gnn_iclr_forward(z, zi_s, labels_yi,labels_mask)
        else:
            raise NotImplementedError
